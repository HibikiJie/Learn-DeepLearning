...
from Chapter03.C03ArcFaceLoss import ArcFaceLoss
...
def visualize(features, labels, epoch):
    ...
    plt.savefig('D:/data/chapter3/image5/epoch%d' % epoch)  # 保存图片
    plt.pause(1)  # 暂停
...
if __name__ == '__main__':
    ...
    for epoch in range(1000):
        ...
        for image, target in data_loader1:
            ...
            '''输入网络，计算损失'''
            feature = net(image)
            loss = loss_function(feature, target)
        ...
        torch.save(net.state_dict(), 'D:/data/chapter3/net9.pt')
