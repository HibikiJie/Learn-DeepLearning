from project3.YOLOWithMobileNet.DATASET import Voc2012DataSet
...
class Trainer:
    ...
    def __init__(self, Net=MobileNetV2):
        ...
        self.data_loader = DataLoader(self.data_set, 9, False, num_workers=4)
        ...
        self.optimizer.load_state_dict(torch.load('D:/data/object3/netparm/optimizer.pth'))
        print('优化器初始化完成')
        ...
        while True:
            ...
            for images, targets_13, targets_26, targets_52 in tqdm(self.data_loader):
                ...
                if i % 100 == 0:
                    ...
                    torch.save(self.optimizer.state_dict(), f'D:/data/object3/netparm/optimizer.pth')
            epoch += 1
