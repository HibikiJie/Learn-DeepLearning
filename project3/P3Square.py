...
category = ['person', 'head', 'hand', 'foot', 'aeroplane', 'tvmonitor', 'train', 'boat', 'dog', 'chair', 'bird',
...
with open('D:/data/object3/voc.txt') as f:
    for line in f.readlines():
        ...
        cv2.imwrite(f'{save_path}/{file_name}', background)
        ...
        with open('D:/data/object3/train.txt', 'a') as f2:
            massage += '\n'
            f2.write(massage)
